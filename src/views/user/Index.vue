    ...
    <div class="container">
      <div class="left-container">
        ...
        <div class="hot-topics">
          <h2 style="padding-left:25px; font-size: 16px; font-family: Arial, sans-serif;">热门话题</h2>
      ...
      <div class="right-container">
        ...
        <table :data="stocks" class="stock-rise">
          <thead>
          <tr>
            <th style="padding: 5px 7px">股票名称</th>
            <th style="padding: 5px 7px">当前价</th>
            <th style="padding: 5px 7px">涨跌幅</th>
          </tr>
          </thead>
          <tbody>
