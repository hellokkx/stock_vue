    ...
    <div class="registArea">
      ...
      <div  v-show="isShow" class="registForm">
        ...
        <div style="flex: 1;display: flex;justify-content: center;align-items: center">
          ...
          <el-button type="primary" plain style="text-align: center;margin-left: 7px" size="small" @click="getCaptcha" :disabled="isCountingDown">
  ...
  methods:{
    ...
    userRegister(){
      if(this.regUser.regUsername===""){
        ...
        register({captcha:this.regUser.captcha,email:this.regUser.email,password:this.regUser.regPwd,userAccount:this.regUser.regUsername}).then(res=>{
